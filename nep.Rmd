...
library(readr)
library(kableExtra)
dt <- read.csv("Data/nep/nepcatchoptions.csv", header = T, row.names = 1)
# dt <- dt [,-1]
...
library(readr)
library(kableExtra)
dt <- read.csv("Data/nep/nepreferencepoints.csv")
dt <- dt [,-1] 
kable(dt, "html")%>%kable_styling(position = "center")%>%
  row_spec(0, bold = T, color = "black", background = "lightgrey")%>%
...
library(icesSAG)
library(kableExtra)
dt <- read.csv("Data/nep/nephistoryadvice.csv")
dt <- dt [,-1] 
...
library(icesSAG)
library(kableExtra)
dt <- read.csv("Data/nep/neplandhist.csv", header = TRUE)
# dt <- dt [,-1] 
# colnames(dt) <- c("Year", "ICES advice", "Pred. Catch", "Pred. landings","TAC", "ICES landings", "Discards", "ICES catch")
kable(dt, "html")%>% 
        kable_styling(position = "center")%>%
