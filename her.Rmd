...
```{r catchoptionsgraphv3, echo = FALSE,fig.height=4.5, fig.width=8}
library(ggplot2)
library(plotly)
 catchoptions <- read.csv("Data/her/herscenariosplot.csv")
 # labels <- catchoptions$Basis
...
library(readr)
library(kableExtra)
dt <- read.csv("Data/her/herreferencepoints.csv")
dt <- dt [,-1] 
kable(dt, "html")%>%kable_styling(position = "center")%>%
  row_spec(0, bold = T, color = "black", background = "lightgrey")
...
library(icesSAG)
library(kableExtra)
dt <- read.csv("Data/her/hercatchhistory.csv")
# dt <- dt [,-1] 
...
library(kableExtra)
dt <- read.csv("Data/her/herlandhist.csv", header = TRUE)
# dt<-unname(dt)
# dt <- dt[,-7]
  kable(dt, "html")%>%kable_styling(position = "center")%>%
...
library(icesSAG)
library(kableExtra)
dt <- read.csv("Data/her/herlandings.csv", header = TRUE)
# dt <- dt [,-1] 
# colnames(dt) <- c("Year", "ICES advice", "Pred. Catch", "Pred. landings","TAC", "ICES landings", "Discards", "ICES catch")
kable(dt, "html")%>% 
        kable_styling(position = "center")%>%
...
library(icesSAG)
library(kableExtra)
dt <- read.csv("Data/her/hertable10.csv", header = TRUE)
# dt <- dt [,-1] 
# colnames(dt) <- c("Year", "ICES advice", "Pred. Catch", "Pred. landings","TAC", "ICES landings", "Discards", "ICES catch")
kable(dt, "html")%>% 
        kable_styling(position = "center")%>%
