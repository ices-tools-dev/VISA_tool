...
***
```{r  out.width = "50%"}
knitr::include_graphics("images/blueling.png")
...
[Go to Standard Graphs page](https://standardgraphs.ices.dk/manage/ViewGraphsAndTables.aspx?key=9467)  
...
The spawning-stock biomass (SSB) has increased since 2004 and has been above MSY Btrigger since 2010. Fishing mortality has
decreased since 2002 and has been lower than FMSY since 2004. Recruitment is estimated to be stable.
